...
public class SendMail {
	...
	public static void send(String from, String tos[], String subject,
		...
		try {
			...
			String filename = "/home/node/eclipse-workspace/CareTeamAPP/target/cucumber-reports/report.html";
			String filename1 = "PatientAPP_Automation_Test_Report";
			BodyPart objMessageBodyPart = new MimeBodyPart();
			// Option 3: Send text along with attachment
			objMessageBodyPart.setContent(
					"<h1>Mail from Babu's Selenium Project!</h1></br>" + text, "text/html");
